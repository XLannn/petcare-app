        ...
        {view === 'forgot_password' ? (
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="link" className="w-full mt-4" onClick={() => setView('sign_in')}>Back to Sign In</Button>
            </CardContent>
          </Card>
        ) : (
          <Card>
            ...
            <CardContent>
              <Tabs defaultValue="signin" className="w-full" onValueChange={(value) => setView(value)}>
                ...
                <TabsContent value="sign_in">
                  <form onSubmit={handleSignIn} className="space-y-4 pt-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Button variant="link" size="sm" className="px-0" onClick={() => setView('forgot_password')}>Forgot Password?</Button>
                    </div>
